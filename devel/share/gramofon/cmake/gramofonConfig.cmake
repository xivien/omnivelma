...
if("TRUE" STREQUAL "TRUE")
  set(gramofon_SOURCE_PREFIX /home/xivien/velma_sim/src/omnivelma/src/gramofon)
  set(gramofon_DEVEL_PREFIX /home/xivien/velma_sim/src/omnivelma/devel)
  set(gramofon_INSTALL_PREFIX "")
  set(gramofon_PREFIX ${gramofon_DEVEL_PREFIX})
else()
  set(gramofon_SOURCE_PREFIX "")
  set(gramofon_DEVEL_PREFIX "")
  set(gramofon_INSTALL_PREFIX /home/xivien/velma_sim/src/omnivelma/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gramofon' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xivien/velma_sim/src/omnivelma/src/gramofon/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gramofon_NUM_DUMMY_TARGETS)
      set(gramofon_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gramofon::wrapped-linker-option${gramofon_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gramofon_NUM_DUMMY_TARGETS "${gramofon_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gramofon::wrapped-linker-option${gramofon_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gramofon_LIBRARIES "${interface_target_name}")
